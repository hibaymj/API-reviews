...
Before I say one thing about any API I find, I want to make one thing perfectly clear: every API I will redesign is the result of a tremendous amount of work for a substantial group of intelligent people. None of this field is really all that intuitive. I often say APIs are [specious](https://www.merriam-webster.com/dictionary/specious), and there are a lot of paths that look great until you find yourself stuck in a deep pit. It takes a tremendous amount of work to change your incidental understanding of HTTP and REST to conform with the specification and style. When people spend a lot of time on work it becomes personal. We become invested in the things we do, and it hurts when people say you're wrong. Usually more when its true. I say this from experience, it isn't fun when your best isn't good enough. I can say with utmost confidence that when it comes to API design, I've been wrong a lot more than almost anyone in the world. I learned from each and every time, and now I'd like to help others avoid some of that suffering. I am not here to, nor do I wish to entertain or engage with anyone looking to, dunk on the hard work of others. Far too much of our API design discussions revolve around subjective opinion and personal preferences. This leads us to an awful lot of suffering. I wish to provide an objective way to discuss API design so we can collectively improve without all this trauma.
...
Knowledge and affordance over data and documentation. Everytime. Every. Time.
